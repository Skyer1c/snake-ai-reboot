...
blue = (50, 153, 213)
class SnakeGame:
    def __init__(self, snake_block, block_count):
        pygame.init()
    ...
    def step(self,action):
        ...
        info ={
            ...
            "snake_head_pos": np.array(self.snake_list[0]),
            "prev_snake_head_pos": np.array(self.snake_list[1]),
    ...
    def render(self):
        ...
        pygame.draw.rect(self.dis, self.yellow, [self.food[0], self.food[1], self.snake_block, self.snake_block])
        self.show_score(self.score)
        for x in self.snake_list[::-1]:
            cnt += 1
            if cnt == 1:
                pygame.draw.rect(self.dis, self.red, [x[0], x[1], self.snake_block, self.snake_block])
            else:
